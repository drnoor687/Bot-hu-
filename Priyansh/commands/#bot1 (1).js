...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "hi") || (event.body.toLowerCase() == "hello") ||(event.body.toLowerCase() == "hlw") || (event.body.toLowerCase() == "helo")) {
     return api.sendMessage("Hello, Hi, Bye bye. Ye sab ke alawa kuch bolna nhi ata Kya tumko Chalo जय श्री राम बोलो", threadID);
   };

   if ((event.body.toLowerCase() == "who is god") || (event.body.toLowerCase() == "bhagwan kon hai")) {
     return api.sendMessage("मुस्लिमो के मान्यता के अनुसार कोई अंतर नहीं है अर्थात ईश्वर और अल्लाह एक ही आईटम है लेकिन हिंदुओ की मान्यता के अनुसार श्री राम ही सत्य है और उसके अतिरिक्त कुछ अन्य पूज्य नहीं है बल्कि मनगढ़ंत है। ईश्वर हर जगह रहते हैं, कण कण में विराजमान हैं। सब कुछ परमात्मा में ही समाया हुआ है। ईश्वर निराकार और साकार दोनों है। ", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "inbox") || (event.body.toLowerCase() == "ib")) {
   ...
   if ((event.body.toLowerCase() == "bot owner") || (event.body.toLowerCase() == "bot admin")) {
     return api.sendMessage("My Owner AestHetic bOy  ASHISH VERMA \ https://www.facebook.com/share/16NXatKn7g/Mr.Ashish.verma🖤", threadID);
   };
